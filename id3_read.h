...
void id3v1 :: get_title(void)
{
	char title[30];
	this ->mp3.seekg(-125,ios::end);
...
void id3v1 :: get_artist(void)
{
	char artist[30];
	this ->mp3.seekg(-95,ios::end);
...
void id3v1 :: get_album(void)
{
	char album[30];
	this ->mp3.seekg(-65,ios::end);
...
void id3v1 :: get_year(void)
{
	char year[5];
	this ->mp3.seekg(-35,ios::end);
...
void id3v1 :: get_comments(void)
{
	char comments[29];
	this ->mp3.seekg(-31,ios::end);
	this->mp3.read(comments,28);
	comments[28]='\0';
	cout << "Year: ";
	if(comments[0] == '\0')
		cout << "Not available " << endl;
...
void id3v1 :: get_genre(void)
{
	char genre[2];
	this ->mp3.seekg(-1,ios::end);
	this->mp3.read(genre,30);
	genre[1]='\0';
	cout << "Genre: ";
	if(genre[0] == '\0')
		cout << "Not available " << endl;
